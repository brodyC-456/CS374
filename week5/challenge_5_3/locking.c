...
// Answer: If there weren't any locks in place, then the two processes would write to the same file concurrently, and the data
// would get all weird and corrupted as the processes overwrite.
